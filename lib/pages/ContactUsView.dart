          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                  'We have established a superior quality flooring business to help add value and protect.',
                  style: TextStyle(
                    color: Colors.white,
                    fontFamily: 'Roboto',
                    fontSize: 20,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text('Elegant Hardwood Flooring'),
              ],
            ),
            Row(
              children: [
                ...
                Text('Luxurious Vinyl Plank Flooring '),
              ],
            ),
            Row(
              children: [
            ...
            Row(
              children: [
                ...
                Text('Durable Laminate Flooring'),
              ],
            ),
            SizedBox(height: 16),
            TextField(
