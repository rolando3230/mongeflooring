...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        color: Color(0xFF080494), // Background color
        child: Center(
          child: SingleChildScrollView(
            child: Column(
              children: [
                // Conditionally display header based on screen width
                screenWidth < 600 ? headermobile() : wenheader(),

                // Image Slider Section
                ImageSliderWithText(), // Adding the image slider here

                // Conditionally display service cards based on screen width
...
class _ImageSliderWithTextState extends State<ImageSliderWithText> {
  ...
  final List<String> _images = [
    'assets/images/21.jpg', // replace with your images
